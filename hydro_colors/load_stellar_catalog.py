# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_load_stellar_catalog.ipynb.

# %% auto 0
__all__ = ['GALS_DIR', 'GALS_FILE', 'Z_SOLAR_HACC', 'Z_SOLAR_PADOVA', 'H0', 'load_hacc_galaxy_data']

# %% ../nbs/01_load_stellar_catalog.ipynb 3
import numpy as np
import os
import matplotlib.pylab as plt

# %% ../nbs/01_load_stellar_catalog.ipynb 4
GALS_DIR = '../hydro_colors/data/test_hacc_stellar_catalog/'
GALS_FILE = 'Gals_Z0.txt'

# %% ../nbs/01_load_stellar_catalog.ipynb 5
...
# %% ../nbs/01_load_stellar_catalog.ipynb 6
...
# %% ../nbs/01_load_stellar_catalog.ipynb 7
